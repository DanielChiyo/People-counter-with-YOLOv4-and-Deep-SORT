...
def main(_argv):
    ...
    X_max = int(size[0]) # change to real value
    ...
    with open('mycsv.csv', 'w', newline='') as file:
        ...
        writer.writerow(['Time', 'Entenred', 'Left', 'Result', 'People inside'])
        ...
        while True:
            ...
            # draw bbox on screen
                ...
                ########################################################################
                cv2.line(frame, (0, 0), (X_max, Y_max), (255, 255, 0), thickness=2)
            ...
            # if enable info flag then print details about each track
                ...
                if(aux < Y_center):
                    ...
                    state = Q1
                '''
                y_centroid = (int(bbox[1]) + int(bbox[3]))/2
                x_centroid = (int(bbox[0]) + int(bbox[2]))/2
                aux = y_centroid - (Y_max/X_max)*x_centroid
            ...
            if(frame_num%frames_per_analysis == 0):
                ...
                writer.writerow([video_current_time, entered, left, result, amount_by_now])
